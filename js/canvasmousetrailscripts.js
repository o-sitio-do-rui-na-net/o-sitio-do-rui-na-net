...
else if(page =="unityworks.html"){
    canvas = document.getElementById("canvasUnity");
}else if(page =="videoclassifer.html"){
    canvas = document.getElementById("canvasVideoClass");
}
